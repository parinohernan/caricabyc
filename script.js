...
document.addEventListener('DOMContentLoaded', () => {
    const animatedElements = document.querySelectorAll('.service-card, .legal-card, .contact-item');
...
if (downloadBtn) {
    downloadBtn.addEventListener('click', (e) => {
        ...
        showNotification('Iniciando descarga de CARICA APK...', 'success');
...
// Contador de estadísticas (ejemplo para futuras implementaciones)
...
// Detectar cuando los contadores están visibles
